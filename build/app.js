...
var NavMenu = React.createClass({displayName: "NavMenu",
	...
	render: function (){
		if (this.state.visible==false){
			return (
				React.createElement("div", {className: "col-xs-2 col-xs-offset-10"}, 
					React.createElement("button", {onClick: this.toggle}, "☰ Menu")
				)
				);
		} 
		else {
			return (	
				React.createElement("div", null, 
					React.createElement("div", {className: "col-xs-offset-6 col-xs-4"}, 
						React.createElement(MenuList, null, " ")
					), 
					React.createElement("div", {className: "col-xs-2"}, 
						React.createElement("button", {onClick: this.toggle}, " X Close")
					)
				)
			);
		}
	...
	render: function(){
		return(
				React.createElement("ul", null, 
					React.createElement("li", null, React.createElement("a", {href: "/"}, "root")), 
					React.createElement("li", null, React.createElement("a", {href: "#aboutme"}, "about")), 
